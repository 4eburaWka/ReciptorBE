...
\newcommand{\chipher}{
        %{\fontsize{16pt}{16pt}\selectfont  КР.ИИ-22.210582-40 03 01}
        {\fontsize{16pt}{16pt}\selectfont  КР.ИИ-21.210563-3 81 00}
}

\newcommand{\theme}{Разработка веб-приложения для поиска кулинарных рецептов с использованием нейронной сети}

\newcommand{\student}{Ливтинюк Т. В.}
